...
class ExploreCategoryStore {
    constructor() {
        this.postsStore = new PostsStore("explore");
    ...
    setCategory = (category) => {
        ...
        this.postsStore.category = category || "all";
    ...
    handleScroll = () => {
        ...
        if (windowBottom >= docHeight && this.postsStore.page > 1) {
            this.postsStore.postsGet();
        }
    }
...
export default new ExploreCategoryStore;