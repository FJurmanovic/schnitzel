    ...
    render() {
        return (
            <div className="text-center">
                <FormComponent
                    className="mx-auto col-7 f4"
                    form={forms}
                    onSubmit={(e) => forms.onSubmit(e, this.hooks)}
                    onCancel={() => this.props.history.push("/")}
                >
                    <InputComponent
                        className="width-full f5 py-2 my-2"
                        message="Username (1-10 characters): "
                        errorMessage="Username must have between 1 and 10 characters."
                        name="username"
                        autoFocus
                    />
                    <InputComponent
                    ...
                    <InputComponent
                        ...
                        errorMessage="The e-mails do not match."
                        name="emailConfirm"
                    />
                    ...
                    <InputComponent
                        className="width-full f5 py-2 my-2"
                        message="Password (3-15 characters): "
                ...
                {this.props.RegisterStore.errorMessage && (
                    <div className="mx-auto col-7 h4 text-red">
                        {this.props.RegisterStore.errorMessage}
                    </div>
                )}
            </div>
